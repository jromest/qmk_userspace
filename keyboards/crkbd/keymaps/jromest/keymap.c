...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                            LT(_LOWER, KC_BTN1),  KC_LCTL,  KC_BTN1,    KC_SPC,  KC_LGUI, LT(_RAISE, KC_LALT)
                        //`----------------------------------------'  `--------------------------------------'
  ),
...
[_LOWER] = LAYOUT_split_3x6_3(
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                        KC_TRNS,  KC_LCTL,  KC_BTN1,    KC_SPC,  KC_LGUI, LT(_RAISE, KC_LALT)
                                    //`----------------------------'  `--------------------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                            LT(_LOWER, KC_BTN1),  KC_LCTL,  KC_BTN1,    KC_SPC,  KC_LGUI, KC_TRNS
                        //`----------------------------------------'  `--------------------------'
  ),
